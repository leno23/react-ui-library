...
Nova UI 当前包含以下组件，已对齐 Ant Design 中后台常用能力：
...
Alert、Modal、Drawer、Toast / Message、Tooltip、Popover、Popconfirm、Loading、Spin、Skeleton、Notification、Tour、Watermark
...
Tabs、Menu、Breadcrumb、Dropdown、Steps、Collapse、Tree、Anchor、Affix、BackTop、FloatButton
